<template>
  <div class="cc-converter-page" v-on:keyup.enter="onEnter">
    <div class="cc-converter-page__input-form form">
      <p class="form-__nstruction">Input string in format "15 usd in rub" to convert</p>
...
export default {
  ...
  methods: {
    ...
    inputValidate() {
      ...
      if (this.inputArray[1].toUpperCase() != 'RUB' && this.inputArray[3].toUpperCase() != 'RUB') {
      ...
      } else if (this.inputArray[1].toUpperCase() == 'RUB' && this.inputArray[3].toUpperCase() == 'RUB') {
        check1 = true;
        check2 = true;
    ...
    onEnter() {
      ...
      this.result = this.inputArray[0] + " " + this.inputArray[1].toUpperCase() + " = " + (this.inputArray[0]*currencyValue1/currencyValue2).toFixed(3) + " " + this.inputArray[3].toUpperCase();
    //   }
    }
  },
  mounted() {
